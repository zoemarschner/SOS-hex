...
field set to a Nx5 matrix with 1 column of jacobians, 3 columns of the u,v,w coordinates of the argmins, and 1 column
of the second eigenvalues of the moment matrix. 
...
save_vtk on the resulting mesh. Note that the resulting mesh is in the correct format to plot the jacobians with plot_mesh
	...
	verbose		optional, if set to true prints progress (default 0)
	save_file	optional, if specified jacobians, argmins, and 2nd eigenvalues will be written to this file
returns:
